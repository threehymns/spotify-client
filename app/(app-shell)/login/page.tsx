  ...
  useEffect(() => {
    ...
    if (errorParam) {
      ...
      const errorMessages = {
        ...
        missing_credentials: "Client credentials are missing. Please re-enter your Spotify API keys.",
        token_exchange:
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (clientId.length !== 32) {
        setError("Client ID should be 32 characters long. Please check your Spotify Developer Dashboard.")
        setLoading(false)
        return
      }
      ...
      if (clientSecret.length !== 32) {
        setError("Client Secret should be 32 characters long. Please check your Spotify Developer Dashboard.")
        setLoading(false)
        return
      }
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-black p-4">
      <Card className="w-full max-w-md border-zinc-800 bg-zinc-950 text-white">
        <CardHeader>
          <CardTitle className="text-2xl font-bold">Connect to Spotify</CardTitle>
          <CardDescription className="text-zinc-400">Enter your Spotify API credentials to get started</CardDescription>
        </CardHeader>
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="text-sm text-zinc-400">
              <p>
                You can get your Spotify API credentials by creating an app in the{" "}
                <a
        ...
        <CardFooter>
          <Button onClick={handleSubmit} className="w-full bg-green-500 hover:bg-green-600" disabled={loading}>
