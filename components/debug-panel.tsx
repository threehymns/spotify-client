...
import { getCredentials, getAccessToken } from "@/lib/auth-helpers"
  ...
  const gatherDebugInfo = async () => {
    ...
    try {
      ...
      const localStorageKeys = Object.keys(localStorage)
        ...
        .reduce((obj, key) => {
          obj[key] = localStorage.getItem(key) ? (key.includes("token") ? "[REDACTED]" : "[PRESENT]") : "[MISSING]"
          return obj
        }, {})
        ...
        <Card className="mt-2 bg-zinc-900 border-zinc-800">
          <CardHeader className="pb-2">
            ...
            <CardDescription className="text-xs">
              Gather information about your Spotify connection for troubleshooting
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button size="sm" variant="outline" onClick={gatherDebugInfo} disabled={loading} className="mb-2">
