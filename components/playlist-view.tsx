...
import { getUserPlaylists, createPlaylist, getPlaylistTracks } from "@/lib/spotify-api"
    ...
    <div className="space-y-8">
      ...
      {playlists.length === 0 ? (
        <div className="py-16 text-center">
          ...
          <h3 className="text-xl font-medium text-white mb-2">No playlists found</h3>
          <p className="text-zinc-400 mb-4">Create your first playlist to get started</p>
          <Dialog>
            <DialogTrigger asChild>
                ...
                <Link href={`/playlists/${playlist.id}`}>
                  <Card className="bg-zinc-900/50 hover:bg-zinc-800/70 transition-all duration-300 border-zinc-800/50 overflow-hidden h-full group-hover:shadow-lg group-hover:shadow-purple-500/5 hover:border-zinc-700/80">
                    ...
                    <CardContent className="p-4">
                      <h3 className="font-semibold text-white line-clamp-1 mb-1 group-hover:text-green-400 transition-colors duration-300">{playlist.name}</h3>
